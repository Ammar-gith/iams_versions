  ...
  const analyticsBarChartEl = document.querySelector('#analyticsBarChart'),
    analyticsBarChartConfig = {
      ...
      series: [
        {
          name: 'All',
          data: [75, 50, 60, 27, 40, 31, 34]
        },
        {
          name: 'Published',
          data: [70, 43, 48, 13, 31, 20, 5]
        },
        {
          name: 'Unpublished',
          data: [5, 7, 12, 17, 9, 17, 26]
        },
        {
          name: 'Pending',
          data: [5, 7, 12, 17, 9, 13, 6]
        },
        {
          name: 'Rejected',
          data: [5, 7, 12, 17, 9, 8, 3]
        }
      ],
      grid: {
...
//   // Top 10 Dep. Analytics - Bar Chart
//   // --------------------------------------------------------------------
//   const top10analyticsEl = document.querySelector('#top10analytics'),
//     top10analyticsConfig = {
//       chart: {
//         height: 250,
//         type: 'bar',
//         toolbar: {
...
//       },
//       xaxis: {
//         categories: ['Communication & Works', 'Planning & Development', 'Local Government', 'Education', 'Health', 'Science & Technology', 'Law Department'],
//         axisBorder: {
//           show: false
//         },
//         axisTicks: {
...
//       }
//     };
//   if (typeof top10analyticsEl !== undefined && top10analyticsEl !== null) {
//     const top10analytics = new ApexCharts(top10analyticsEl, top10analyticsConfig);
//     top10analytics.render();
//   }

  // Top 10 Dep. Analytics - Bar Chart
  // --------------------------------------------------------------------
  document.addEventListener("DOMContentLoaded", function () {
    const series = window.chartData || [];
    ...
    const options = {
        ...
        colors: ['#6c757d', '#ffc107', '#198754', '#0dcaf0', '#dc3545'],
        legend: {
            position: 'top'
        },
        dataLabels: {
    ...
    new ApexCharts(document.querySelector("#weeklyAdChart"), options).render();
    });
