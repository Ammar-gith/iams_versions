        ...
        <div class="card mb-4">
            <div class="card-header col-md-12 d-flex justify-content-between gap-2 align-items-center">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <h5 class="h5-reset-margin">PO List Summary</h5>
                    @if (empty($bankWiseData))
                        <span class="text-muted">No PO List to show</span>
                    @endif
                </div>
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ route('payment.newspapers.po-list-summary.export.excel', request()->query()) }}"
                        class="custom-excel-button me-2">Export Excel</a>
                    <a href="{{ route('payment.newspapers.po-list-summary.export.pdf', request()->query()) }}"
                            ...
                            <form method="GET" action="{{ url()->current() }}" class="js-local-advanced-form">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3"><label class="form-label">INF Number</label><input type="text"
                                            name="inf_number" class="form-control" value="{{ request('inf_number') }}">
                                    </div>
                                    ...
                                    <div class="mb-3"><label class="form-label">Newspaper</label><select
                                            name="newspaper_id" class="form-select">
                                    ...
                                    <div class="mb-3"><label class="form-label">Submission Date</label><input
                                            type="text" name="submission_date" id="submission_date" class="form-control"
                ...
                <table class="table table-bordered-stripped  mb-3 js-local-filter-table">
                    ...
                    <tbody>
                        ...
                        @foreach ($bankWiseData as $bankData)
                            ...
                            {{-- Show agency split for clarity
                            @if (!empty($bankData['totals']['agency_total']))
                                <tr class="table-light">
                                    {{-- <td></td> --}}
                            {{-- <td class="text-muted">Agency Total ({{ $bankData['bank_name'] }})</td> --}}
                            {{-- <td class="text-end fw-bold">
                                        {{ number_format($bankData['totals']['agency_total']) }}
                                    </td> --}
                                </tr>
                            @endif --}}
