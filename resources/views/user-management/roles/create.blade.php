...
@push('content')
    ...
    <div class="row">
        <div class="card" style="padding-inline: 0; border-radius: 18px 18px 9px 9px;">
            <form action="{{ route('userManagement.role.store') }}" method="POST" class="card-body" enctype="multipart/form-data" style="padding: 0;">
                @csrf

                {{-- Title (Header) --}}
                <div class="form-header flex w-full">
                    <h5 class="h5-reset-margin">Add Role Form</h5>
                </div>
                ...
                <div class="form-padding">
                    ...
                    <div class="row mb-3 g-3">
                        <div class="col-sm-4">
                            <label class="form-label-x" for="name">Role Name</label>
                ...
                <div class="buttons-div flex">
                    {{-- Save User --}}
                    <button type="submit" class="custom-primary-button">Save Role</button>
