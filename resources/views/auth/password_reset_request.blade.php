                ...
                <div class="authentication-inner py-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- /Logo -->
                            <h3 class="mb-2 text-center" style="color: #245142;">Request Password Reset</h3>
                            <p class="mb-4 text-center" style="color: #E4BF61; font-style: italic">Enter your registered email address to request a password reset.</p>
                            ...
                            <form id="formAuthentication" class="mb-3" action="{{ route('password-reset.request') }}" method="POST">
                                @csrf
                                <div class="mb-3">
