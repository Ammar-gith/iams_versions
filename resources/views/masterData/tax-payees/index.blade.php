        ...
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-header col-md-12 d-flex justify-content-between align-items-center">
                    <h5>Tax Payees List</h5>
                    <a href="{{ route('master.taxPayee.create') }}" class="custom-primary-button">Add Tax Payee</a>
                </div>
                <div class="table-responsive text-nowrap">
                    <table class="table">
                        ...
                        <tbody class="table-border-bottom-0">
                            @foreach ($taxPayees as $key => $taxPayee)
                                <tr>
                                    <td>{{ ++$key }}</td>
                                    ...
                                    <td class="text-center align-middle">
                                        <div class="d-flex justify-content-center align-items-center">
                                            ...
                                            <div class="action-item custom-tooltip">
                                                <a href="{{ route('master.taxPayee.show', $taxPayee->id) }}">
                                                    <i class="bx bx-show-alt fs-4 bx-icon"></i>
                                                </a>
                                                <span class="tooltip-text">View Payee</span>
                                            </div>

                                            {{-- Edit (Update) --}}
                                            <div class="action-item custom-tooltip">
                                                <a href="{{ route('master.taxPayee.edit', $taxPayee->id) }}">
                                                    <i class='bx bx-edit-alt fs-4 bx-icon'></i>
                                                </a>
                                                <span class="tooltip-text">Edit Payee</span>
                                            </div>
                                            ...
                                            <div class="action-item custom-tooltip">
                                                ...
                                                <span class="tooltip-text">Delete Payee</span>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
