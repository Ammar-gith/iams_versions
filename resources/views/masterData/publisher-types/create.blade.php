...
@push('content')
    ...
    <div class="row">
        <div class="card" style="padding-inline: 0; border-radius: 18px 18px 9px 9px;">
            <form action="{{ route('publisherType.store') }}" method="POST" class="card-body" enctype="multipart/form-data" style="padding: 0;">
                @csrf

                {{-- Title (Header) --}}
                <div class="form-header flex w-full">
                    <h5 class="h5-reset-margin">New Publisher Type</h5>
                </div>
                    ...
                    <div class="row mb-3 mx-5 ">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="code" id="alignment-username" class="form-control"
                                placeholder="Enter publisher type code..." />
                        </div>
                        @error('code')
                    ...
                    <div class="row mb-3 mx-5  ">
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="description" id="alignment-username" class="form-control"
                                placeholder="Enter publisher type description..." />
                        </div>
                        @error('description')
                            <span class="alert alert-danger">{{ $message }}</span>
                        @enderror
