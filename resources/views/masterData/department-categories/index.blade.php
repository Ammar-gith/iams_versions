        ...
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-header col-md-12 d-flex justify-content-between align-items-center">
                    <h5>Department Categories List</h5>
                    <a href="{{ route('master.department.departmentCategory.create') }}" class="custom-primary-button">Add Category</a>
                </div>
                <div class="table-responsive text-nowrap">
                    <table class="table">
                        ...
                        <tbody class="table-border-bottom-0">
                            @foreach ($department_categories as $key => $department_category)
                                <tr>
                                    <td>{{ ++$key }}</td>
                                    ...
                                    <td class="text-center align-middle">
                                        <div class="d-flex justify-content-center align-items-center">
                                            ...
                                            <div class="action-item custom-tooltip">
                                                <a href="{{ route('master.department.departmentCategory.show', $department_category->id) }}">
                                                    <i class="bx bx-show-alt fs-4 bx-icon"></i>
                                                </a>
                                                <span class="tooltip-text">View Department Category</span>
                                            </div>

                                            {{-- Edit (Update) --}}
                                            <div class="action-item custom-tooltip">
                                                <a href="{{ route('master.department.departmentCategory.edit', $department_category->id) }}">
                                                    <i class='bx bx-edit-alt fs-4 bx-icon'></i>
                                                </a>
                                                <span class="tooltip-text">Edit Department Category</span>
                                            </div>
                                            ...
                                            <div class="action-item custom-tooltip">
                                                ...
                                                <span class="tooltip-text">Delete Department Category</span>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
