...
@push('style')
    <style>
        ...
        .scrolling-wrapper {
            ...
            border-radius: 4px;
            overflow: hidden;
            /* hides text that goes beyond the wrapper */
            white-space: nowrap;
        ...
        .scrolling-text {
            ...
            /* allows width to be based on content */
            animation: scroll-left 40s linear infinite;
            padding-left: 100%;
            /* start from the right edge of the wrapper */
        }
        ...
        <div class="col-lg-12 col-md-12">
            <div class="dashboard-title d-flex align-items-end justify-content-between mb-3 pb-1">
                <div class="dashboard-date">
                    <h5 class="h5-reset">IPR Dashboard</h5>
                    <small>{{ $today }}</small>
                </div>
        ...
        <div class="col-lg-12 col-md-8">
            <div class="scrolling-wrapper">
                <div class="scrolling-text">
                    Keep visiting the Portal at least 3-4 times a day to keep yourself updated regarding Advertisements
                    ...
                    <div class="d-flex justify-content-around">
                        <div class="d-flex flex-column gap-3">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                {{-- total amount aviable in the pla account  --}}
                                <div class="card-info">
                                    <h4 class="h4-reset mb-0">Rs {{ number_format($totalChequeAmountPla) }}
                                    </h4>
                                    {{-- <h4 class="h4-reset mb-0">Rs {{ number_format($totalChequeAmountPla / 1_000_000, 2) M}}
                                    </h4> --}}
                            ...
                            <div class="d-flex flex-column">
                                <a href="{{ route('reports.newspaper.pla.amount') }}">
                                    <small>Newspapers &#8211; {{ $newspaperCount }}</small>
                                </a>
                                <a href="{{ route('reports.agency.pla.amount') }}">
                                    <small>Agencies &#8211; {{ $advAgencyCount }} </small>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="d-flex flex-column justify-content-around">
                            <div class="d-flex align-items-center justify-content-between gap-3">
                                {{-- total cheque amount form billing which will be receive from the clinet offices --}}
                                <div>
                            ...
                            <div class="d-flex align-items-center justify-content-between gap-3">
                                <div>
                                    <h6 class="h6-reset mb-0 me-2">Rs
                                        {{ number_format($netPayAbleAmount) }} </h6>
                                    {{-- <h6 class="h6-reset mb-0 me-2">Rs
