            ...
            <div class="card">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div class="d-flex justify-content-end">
                        ...
                        <h5 class="mt-2">Department Wise Advertisement Report</h5>
                    </div>
                ...
                <div class="card-body">
                    {{-- Filter Form --}}
                    <form method="GET" action="{{ route('reports.departments') }}" class="row g-3 mb-4">
                        {{-- Department Dropdown --}}
                        <div class="col-md-3">
                            <select name="department_id" class="form-control select2 rounded-pill">
                        ...
                        <div class="col-md-3 d-flex gap-2">
                            ...
                            <a href="{{ route('reports.departments') }}" class="btn btn-outline-warning rounded-pill flex-fill">Reset</a>
                        </div>
                    </form>

                    {{-- Summary Cards --}}
                    @php
                        $totalAds = collect($data)->sum('count');
                        $totalDepts = count($data);
                        $avgPerDept = $totalDepts > 0 ? round($totalAds / $totalDepts) : 0;
                    @endphp
                    <div class="row g-3 mb-4">
                            ...
                            <div class="card shadow-sm border-0 h-100">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <h4 class="fw-bold text-primary mb-0">{{ $totalDepts }}</h4>
                            ...
                            <div class="card shadow-sm border-0 h-100">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <h4 class="fw-bold text-success mb-0">{{ number_format($totalAds) }}</h4>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="card shadow-sm border-0 h-100">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6 class="text-muted mb-1">Average per Department</h6>
                                        <h4 class="fw-bold text-info mb-0">{{ number_format($avgPerDept) }}</h4>
                                        <small class="text-muted">Ads / Dept</small>
                                    </div>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="3" class="text-center text-muted py-4">
                                            No department records found for the selected filters.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
