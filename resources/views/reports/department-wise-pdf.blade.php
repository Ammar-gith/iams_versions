...
<body>
    <div class="header">
        ...
        <p><strong>{{ $title ?? 'Department Wise Report' }}</strong></p>
    ...
    <table>
        ...
        <tbody>
            ...
            @foreach ($data as $item)
                @php $total += $item['total_advertisements']; @endphp
                <tr>
                    <td>{{ $loop->iteration }}</td>
                    <td>{{ $item['department_name'] }}</td>
                    <td class="text-right">{{ number_format($item['total_advertisements']) }}</td>
                </tr>
            @endforeach
        </tbody>
        <tfoot>
