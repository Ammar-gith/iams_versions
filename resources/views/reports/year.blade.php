            ...
            <div class="card">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div class="d-flex justify-content-end">
                        ...
                        <h5 class="mt-2">Year Wise Advertisement Report</h5>
                    </div>
                ...
                <div class="card-body">
                    {{-- Filter Form --}}
                    <form method="GET" action="{{ route('reports.years') }}" class="row g-3 mb-4">
                        <div class="col-md-3">
                    ...
                    @php
                        ...
                        $totalAds = collect($data)->sum('total');
                        $avgPerYear = $totalYears > 0 ? round($totalAds / $totalYears) : 0;
                    @endphp
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="card shadow-sm border-0 h-100">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6 class="text-muted mb-1">Total Years</h6>
                                        <h4 class="fw-bold text-primary mb-0">{{ $totalYears }}</h4>
                                        <small class="text-muted">Years with data</small>
                                    </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="card shadow-sm border-0 h-100">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6 class="text-muted mb-1">Average per Year</h6>
                                        <h4 class="fw-bold text-info mb-0">{{ number_format($avgPerYear) }}</h4>
                                        <small class="text-muted">Ads / Year</small>
                                    </div>
                        ...
                        <table class="table table-striped table-hover align-middle">
                            <thead class="table-light">
                                <tr>
                                    <th width="10%">S. No.</th>
                                    <th width="60%">Year</th>
                                    <th width="30%" class="text-end">Total Advertisements</th>
                                </tr>
                            </thead>
                            <tbody>
