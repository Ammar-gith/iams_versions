            ...
            <div class="card">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div class="d-flex justify-content-end">
                        ...
                        <h5 class="mt-2">Category Wise Advertisement Report</h5>
                    </div>
                ...
                <div class="card-body">
                    {{-- Filter Form --}}
                    <form method="GET" action="{{ route('reports.categories') }}" class="row g-3 mb-4">
                        {{-- Category Dropdown --}}
                        <div class="col-md-3">
                            <select name="category_id" class="form-control select2 rounded-pill">
                    ...
                    @php
                        ...
                        $avgPerCategory = $totalCategories > 0 ? round($totalAds / $totalCategories) : 0;
                    @endphp
                    <div class="row g-3 mb-4">
                            ...
                            <div class="card shadow-sm border-0 h-100">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <h4 class="fw-bold text-primary mb-0">{{ $totalCategories }}</h4>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="card shadow-sm border-0 h-100">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6 class="text-muted mb-1">Average per Category</h6>
                                        <h4 class="fw-bold text-info mb-0">{{ number_format($avgPerCategory) }}</h4>
                                        <small class="text-muted">Ads / Category</small>
                                    </div>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="3" class="text-center text-muted py-4">
                                            No category records found for the selected filters.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
